...
export const UPDATE_TRAINING_CONTEXT_TOOL: ToolDefinition = {
  ...
  function: {
    ...
    description:
      "Update the athlete's training context — a free-text description of where and when they train, their equipment, schedule constraints, and any other environment details. The AI coach uses this to give personalized recommendations. Replaces the previous context entirely.",
    parameters: {
      type: "object",
      properties: {
        trainingContext: {
          type: "string",
          description:
            "The new training context text. Should be detailed — include location, times, equipment, constraints, and anything relevant to training recommendations.",
        },
      },
...
export const MANAGE_GOALS_TOOL: ToolDefinition = {
  ...
  function: {
    name: "manage_goals",
    description:
      "Create, update, delete, or list race goals. Use this when the athlete wants to set a new race target, modify an existing goal, remove one, or view their current goals. Always confirm with the athlete before making changes.",
    parameters: {
      type: "object",
      properties: {
        action: {
          ...
          description:
            "What to do with the goal. Use 'list' to fetch all active goals without any goal data — the LLM can use this to remind the athlete of their current goals.",
        },
        goal: {
          type: "object",
          ...
          properties: {
            ...
            priority: {
              type: "string",
              enum: ["A", "B", "C"],
              description: "Goal priority. A = most important.",
            },
            goalStatement: {
              type: "string",
              description: "Personal statement or motivation for this goal.",
            },
            status: {
              type: "string",
...
export const SET_ACTIVITY_AS_GOAL_TOOL: ToolDefinition = {
  ...
  function: {
    ...
    description:
      "Promote an existing activity (training log entry) to a race goal. Pre-fills the goal name, distance, and elevation from the activity. The athlete can then refine the goal settings.",
    parameters: {
      type: "object",
      properties: {
        activityId: {
        ...
        targetDate: {
          type: "string",
          description:
            "The race date in YYYY-MM-DD format. Defaults to a reasonable date after the activity if not specified.",
        },
        goalStatement: {
          type: "string",
...
export const UPDATE_WEEKLY_PLAN_TOOL: ToolDefinition = {
  ...
  function: {
    ...
    description:
      "Update a single week of the athlete's training plan — modify planned sessions, adjust volume/elevation/duration targets, or add coach notes. Use this when the athlete asks to adjust a specific week or make minor changes to an existing plan. For full multi-week plan creation (phases leading to a race goal), use create_training_phase instead. Past days (already passed) are automatically skipped.",
    parameters: {
      type: "object",
      properties: {
        weekStart: {
          type: "string",
          description:
            "Optional ISO date (YYYY-MM-DD) for the Monday of the week to plan. Omit to plan the upcoming week (next Monday).",
        },
        sessions: {
          type: "array",
          description:
            "Planned sessions for the upcoming week. If omitted, session targets are not changed. Each session represents one day's workout.",
          items: {
            type: "object",
            properties: {
              dayOfWeek: {
              ...
              description: {
                type: "string",
                description:
                  "Full description of the session, including workout details, pace zones, duration, etc.",
              },
              targetDistance: {
                type: "number",
                description:
                  "Target distance in meters. Omit or set to 0 for rest days or non-distance sessions.",
              },
              targetElevation: {
                type: "number",
    ...
    parameters: {
      ...
      properties: {
        weekStart: {
          type: "string",
          description:
            "Optional ISO date (YYYY-MM-DD) of the Monday of the week to read. Omit to read the current week.",
        },
      },
    },
  },
...
export const UPDATE_TRAINING_DAY_TOOL: ToolDefinition = {
  ...
  function: {
    ...
    description:
      "Change ONE day's planned session in a specific week of the athlete's training plan — e.g. turn a workout into a rest day, adjust a target distance, or rewrite the session description. Only the fields you provide are changed; all other days in that week are left untouched. Use this for single-day adjustments. For whole-week edits (volume targets, coach notes, full re-plan), use update_weekly_plan instead. Past days (already passed) are automatically rejected.",
    parameters: {
      type: "object",
      properties: {
        weekStart: {
          type: "string",
          description:
            "Required ISO date (YYYY-MM-DD) of the Monday of the week containing the day to change.",
        },
        dayOfWeek: {
          type: "integer",
          minimum: 0,
...
export const QUERY_ACTIVITIES_TOOL: ToolDefinition = {
  ...
  function: {
    ...
    description:
      "Query the athlete's training activity history. Use this when the athlete asks about past performances, PRs, recent workouts, pace data, or wants to compare previous efforts. Returns up to 20 activities matching the filters with key stats (distance, duration, pace, elevation, HR, power, TSS, remarks).",
    parameters: {
      type: "object",
      properties: {
        type: {
        ...
        search: {
          type: "string",
          description:
            "Free-text search against activity names. Use distance filters (minDistance/maxDistance) when names are unknown.",
        },
        minDistance: {
          type: "number",
    ...
    parameters: {
      ...
      properties: {
        phaseName: {
          type: "string",
          description:
            "Name of this training phase (e.g. 'Base Phase', 'Build Phase 1', 'Build Phase 2', 'Peak Phase', 'Taper'). Indicates its position in the periodization cycle.",
        },
        phaseGoal: {
          type: "string",
          description:
            "The specific training goal for this phase, e.g. 'Build aerobic base from 50km to 65km/week with 80% easy running' or 'Introduce threshold work with one quality session per week'",
        },
        raceGoalId: {
          type: "string",
          description:
            "The ID of the race goal this phase targets. Get this from the training context's race goals list.",
        },
        phaseOrder: {
          type: "integer",
          minimum: 1,
          description:
            "Sequence number of this phase in the overall plan (1, 2, 3...). Phase 1 is the first phase from the start date.",
        },
        weeks: {
          type: "array",
          minItems: 1,
          description:
            "The weeks in this phase (1+ weeks). Weeks must be consecutive starting from the phase start date.",
          items: {
            type: "object",
            ...
            properties: {
              weekNumber: {
                type: "integer",
                minimum: 1,
                description: "Week number within this phase (1-based).",
              },
              weekStart: {
                type: "string",
                description: "ISO date (YYYY-MM-DD) of the Monday of this week.",
              },
              coachNotes: {
                type: "string",
                description:
                  "Optional rationale for this week — e.g. 'Volume build week', 'Cutback/recovery week at ~80% volume', 'Peak intensity week'",
              },
              targetVolumeMeters: {
                type: "number",
                description:
                  "Target weekly volume in meters. Progression within phase: generally increasing with occasional cutback weeks.",
              },
              targetElevationMeters: {
                type: "number",
                description:
                  "Target weekly elevation gain in meters. Scale with volume; if the race course is hilly include meaningful elevation.",
              },
              sessions: {
                type: "array",
                description:
                  "All 7 daily sessions for this week (include rest days explicitly). Past days (already passed) are auto-skipped.",
                items: {
                  type: "object",
                  required: ["dayOfWeek", "type"],
                  properties: {
                    ...
                    description: {
                      type: "string",
                      description:
                        "Full description — workout details, pace zones, duration, terrain, intensity cues",
                    },
          ...
          items: {
            ...
            properties: {
              ...
              phaseGoal: {
                type: "string",
                description:
                  "The specific training goal for this phase, e.g. 'Build aerobic base from 50km to 65km/week' or 'Introduce threshold work with one quality session per week'",
              },
              raceGoalId: {
                type: "string",
                description:
              ...
              phaseOrder: {
                ...
                minimum: 1,
                description:
                  "Sequence number of this phase in the overall plan (1, 2, 3...). Phase 1 is the first phase.",
              },
              weeks: {
                type: "array",
                minItems: 1,
                ...
                items: {
                  ...
                  properties: {
                    ...
                    coachNotes: {
                      type: "string",
                      description:
                        "Optional rationale for this week — e.g. 'Volume build week', 'Cutback/recovery week at ~80% volume'",
                    },
                    targetVolumeMeters: {
                      type: "number",
                      description: "Target weekly volume in meters.",
                    ...
                    sessions: {
                      type: "array",
                      description:
                        "All daily sessions for this week (include rest days explicitly). Past days are auto-skipped.",
                      items: {
                        type: "object",
                        required: ["dayOfWeek", "type"],
                        properties: {
    ...
    parameters: {
      ...
      properties: {
        raceName: {
          type: "string",
          description:
            "The name of the race/event to look up (e.g. 'Chicago Marathon', 'Leadville 100', 'LangBiang 100K').",
        },
        year: {
          type: "string",
