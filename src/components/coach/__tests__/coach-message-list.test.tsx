...
describe("CoachMessageList", () => {
  ...
  it("renders user message on the right", () => {
    render(
      <CoachMessageList
        {...defaultProps}
        messages={[{ ...sampleMessage, content: "Hello coach" }]}
      />
    );
  ...
  it("renders summary message with special styling", () => {
    render(
      <CoachMessageList
        {...defaultProps}
        messages={[{ ...sampleMessage, id: "summary", role: "assistant", content: "Summary" }]}
      />
    );
