  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold">Race Goals</h1>
          <p className="text-muted-foreground mt-1">Set your target races and track your progress</p>
        </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <Link href={`/goals/${goal.id}`} className="text-lg font-semibold hover:text-primary">{goal.name}</Link>
