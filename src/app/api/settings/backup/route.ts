  ...
  const [
    ...
    prisma.$queryRawUnsafe(
      `SELECT id, user_id AS "userId", external_id AS "externalId",
              ...
              zone1_pct AS "zone1Pct",
              zone2_pct AS "zone2Pct",
              zone3_pct AS "zone3Pct",
              zone4_pct AS "zone4Pct",
              zone5_pct AS "zone5Pct",
              intensity_analyzed_seconds AS "intensityAnalyzedSeconds",
              decoupling_pct AS "decouplingPct",
