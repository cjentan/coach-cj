...
export default function DuplicatesPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold flex items-center gap-2">
            <Copy className="h-6 w-6 text-primary" /> {t("title")}
          </h1>
      ...
      {snapshotMessage && (
        <div
          className={`flex items-center gap-2 p-3 mb-4 rounded-md text-sm ${
                      ...
                      {active.map((activity) => {
                        ...
                        return (
                          <button
                            key={activity.id}
                            onClick={() =>
                              setSelectedKeep((prev) => ({ ...prev, [group.id]: activity.id }))
                            }
                          ...
                          >
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <span
                                className={`text-xs font-medium ${isSelected ? "text-green-700 dark:text-green-300" : "text-muted-foreground"}`}
                              >
    ...
    <div className="flex items-center gap-3 flex-wrap">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-2">
          <span
            className={`text-sm font-medium truncate ${isSelected ? "text-green-700 dark:text-green-300" : ""}`}
          >
            {activity.name}
          </span>
