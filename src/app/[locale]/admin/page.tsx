            ...
            <div className="max-w-3xl space-y-6">
              {prompts.map((p) => (
                <PromptEditorCard
                  ...
                  prompt={p}
                  onSave={savePrompt}
                  saved={promptsSaved[p.key] || false}
...
function PromptEditorCard({
  ...
  prompt: { key: string; label: string; description: string; default: string; current: string };
      ...
      <CardContent>
        <div className="space-y-3">
          ...
          <textarea
            ...
            rows={12}
            className="w-full rounded-md border border-input bg-background px-3 py-2 text-xs font-mono leading-relaxed ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 resize-y"
          />
          <div className="flex items-center justify-between">
            <div>
              {saved && (
            ...
            <Button
              size="sm"
              disabled={saving || editValue === prompt.current}
